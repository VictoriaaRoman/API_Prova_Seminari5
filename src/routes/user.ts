...
import { deletePerson, getPerson, getPeople, postPerson, updatePerson, getSubjectsByUser, postQuestionSurname } from "../controllers/user";
...
router.get("/subjectsByUser/:idUser",getSubjectsByUser);
router.post("/surname",postQuestionSurname);
